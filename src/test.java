...
class InstrumentMain
{
    public static void main(String args[])
    {
        ...
        for (int i=0; i< arr.length;i++)
        {
            ...
            arr[i].Play();
            if (arr[i] instanceof Piano) { System.out.println("Piano"); }
            if (arr[i] instanceof Flute) { System.out.println("Flute"); }
            if (arr[i] instanceof Guitar) { System.out.println("Guitar"); }
        }
    }
}
